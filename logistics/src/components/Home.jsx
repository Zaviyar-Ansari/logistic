...
import img10 from './Images/steptodown.com448225.jpg'
import { faChevronDown } from '@fortawesome/free-solid-svg-icons';
import img11 from './Images/medium-shot-smiley-man-warehouse.jpg'
import img12 from './Images/steptodown.com740984.jpg'
import img13 from './Images/steptodown.com338909.jpg'
import img14 from './Images/steptodown.com546607.jpg'
...
const Home = () => {
  ...
  <div className='flex flex-row justify-between relative h-[70vh]'>
    <div className='w-1/2 px-16 py-8 bg-primary3'>
      ...
      <p className='text-4xl font-extrabold font-Inter text-white'>We Create Opportunity to Reach Potiential</p>
    </div>
    <div className='w-1/2'>
...
<div className='relative'>
  ...
  <div className='w-[40vh] h-[30vh] bg-gray-800 opacity-90 absolute inset-0'></div>
  <div className='w-[40vh] h-[30vh] text-center absolute inset-0 flex flex-col justify-center items-center space-y-6 pt-20'>
...
<div className='relative'>
  ...
  {/*banner type image form and text section*/}
   <div className='relative mb-44'>
    ...
    <div className='w-full h-[60vh] bg-gray-800 opacity-40 absolute inset-0'></div>
